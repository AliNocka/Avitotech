...
class Server:
    """
    Класс сервера, отвечающий за настройку роутинга и подключение к бд
    В качестве параметров принимает в себя путь до конфига, в котором содержатся данные для
    подключения к бд, а также имя используемой базы
    """
